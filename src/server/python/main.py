            ...
            try:
                ...
                if sensor.sensorID not in pascoSensorsLastMeasurementTime or (sensor.sensorID in pascoSensorsLastMeasurementTime and pascoSensorsLastMeasurementTime[sensor.sensorID] + seconds < time.time()):
                    ...
                    #     print("VWCClay: " + str(VWCClay))
                        ...
                        White = pascoSensors[sensor.sensorID].read_data("White")
                        await prisma.measurement.create(
                            data={
                                "sensorId": sensor.id,
                                "value": White,
                        ...
                        SolarIrradience = pascoSensors[sensor.sensorID].read_data("SolarIrradience")
                        await prisma.measurement.create(
                            data={
                                "sensorId": sensor.id,
                                "value": SolarIrradience,
                                "type": "SolarIrradience"
                            }
                        )
                        print("SolarIrradience: " + str(SolarIrradience))
